...
> **域名：** 泛解析 `*.sc5.top` → 建议使用固定子域名  
> **仓库：** https://github.com/SuiDiFi/wechathook

---

## 1. DNS 配置（泛解析下需显式使用的子域名）

| 子域名 | 用途 | 指向 |
|--------|------|------|
| `bot.sc5.top` | bot-server `/super/*` | `118.25.42.248` |
| `admin.sc5.top` | 萌兔总代 + 总控 | `118.25.42.248` |
...
| 位置 | 组件 | 端口/域名 |
|------|------|-----------|
| **云** | bot-server | `bot.sc5.top` → 内网 `8788` |
| **云** | admin | `admin.sc5.top` → 内网 `8790` |
